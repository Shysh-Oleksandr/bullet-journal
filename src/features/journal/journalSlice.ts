    ...
    notes: [
        {
            ...
            content: "Half a day I polish the wooden bed of my parents with my mom. I still didn't get it - why should I have done it?",
            color: '#ef6ecd',
        ...
        },
        {
            ...
            content: 'Was going to run 8 km, but since I got strengh, ran 10 instead. Felt very bad after the running. But accomplished my goal',
            color: '#ccaacb',
            category: 'Sport',
            type: NoteTypes.EVENT,
            // author: 'me',
