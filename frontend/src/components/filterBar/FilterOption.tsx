...
const FilterOption = ({ option, filterData, filterDataSetters, setShowFullAddForm }: FilterOptionProps) => {
  ...
  return (
    <div
      ...
      className={`filter-option min-w-[12rem] cursor-pointer relative flex-between mx-3 pl-4 pr-7 py-3 mt-2 flex-1 xs:basis-[15%] basis-full rounded-lg shadow-md text-cyan-700 transition-all duration-[250ms] ${isModalOpened ? '!bg-cyan-600 !text-white !shadow-lg focused' : ''
